...
export function LibrarySearch({ onBookClick }: LibrarySearchProps) {
    ...
    <div className="w-full max-w-6xl mx-auto px-4">
      <div className="relative mb-6">
        <Input
          ...
          className="w-full pl-10 pr-4 py-2 text-sm bg-card border-border rounded-full 
                   focus:outline-none focus:border-[#C45C2E] placeholder:text-muted-foreground"
          value={searchTerm}
